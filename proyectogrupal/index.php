                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <form action="../login.php" method="POST">
                                    <div class="form-group prueba">
                                        ...
                                        <input type="email" class="form-control" id="correo_user" name="correo_user" aria-describedby="emailHelp" >
